...
@section('body')
    <div class="flex flex-col h-[calc(100vh-100px)]">
        ...
        <div class="mb-6 flex justify-between items-center fade-in-up">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 tracking-tight">Access Control</h1>
                <p class="text-gray-500 text-sm mt-1">Manage permissions for Users and Units</p>
            </div>
            <div class="hidden md:block">
                <span
                    class="bg-indigo-100 text-indigo-800 text-xs font-bold px-3 py-1 rounded-full border border-indigo-200 shadow-sm uppercase tracking-wider">
